...
* **`prompt_data/lore_writer/overall_rules.md`**:  содержит детальный протокол разработки лора (концепт-документы, итеративное согласование, самопроверка) при написании лора непосрдественно с пользователем
...
Вдохновение для создания мира черпается из таких источников, как мрачное фэнтези Warcraft, уютное и глубокое повествование Frieren, а также космический ужас и непостижимость Лавкрафта.
